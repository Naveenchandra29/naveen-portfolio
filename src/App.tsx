...
const achievementEvidence: AchievementEvidence[] = [
  ...
  { image: '/achievements/awards/ieeemembership.png', title: 'IEEE Member', description: 'Member of the IEEE Signal Processing Society, with active participation in technical activities and workshops.', alt: 'IEEE membership evidence' },
  ...
  { image: '/achievements/publications/grant.png', title: 'Project Grant', description: 'Received ₹6,000 KSCST funding for the Oral Cancer Detection project under the Student Project Programme.', alt: 'Government project grant evidence' },
  { image: '/achievements/publications/researchpaper.png', title: 'PAPER PUBLICATION - Oral Cancer Detection Using Raspberry Pi and CNN for Early Diagnosis', description: 'Published the CNN-driven Raspberry Pi framework for multi-class oral lesion diagnosis in IJCRT.', alt: 'Oral Cancer Detection research paper preview', link: '/achievements/publications/researchpaper.pdf', action: 'VIEW PAPER ↗' },
